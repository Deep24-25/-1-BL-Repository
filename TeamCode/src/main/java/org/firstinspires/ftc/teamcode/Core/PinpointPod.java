...
@DeviceProperties(
        name = "Pinpoint",
        xmlTag = "pinpoint",
        description ="goBILDA Pinpoint"
)

public class PinpointPod extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
    ...
    public PinpointPod(I2cDeviceSynchSimple deviceClient, boolean deviceClientIsOwned) {
